...
The attribute/context list and the render-vs-hyperlink distinction this
module encodes: src-like contexts, CSS urls, preloads, and og:image are
renderable (localized even if external); href on <a> is a hyperlink
(followed only if internal).
